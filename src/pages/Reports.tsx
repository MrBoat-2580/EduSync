            ...
            <div className="card print-area p-8">
              ...
              <div className="flex items-center justify-between border-b-2 border-ink-900 pb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="display text-xl font-bold text-ink-900">{schoolName}</h1>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <Info
                  label="Grade Level"
                  value={student.class ? classLevelLabel(student.class.grade_level) : '—'}
                />
              </div>
              ...
              <p className="mt-8 text-center text-[10px] text-ink-400">
                This report was generated by {schoolName} Admin System on {today}.
              </p>
            </div>
          )}
        </div>
