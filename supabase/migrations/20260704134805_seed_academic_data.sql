...
INSERT INTO classes (name, code, instructor, grade_level, capacity) VALUES
  ('Foundations of Computing', 'CS 101', 'Dr. R. Tanaka', 1, 40),
  ('Introduction to Programming', 'CS 110', 'Prof. L. Ahmed', 1, 45),
  ('Calculus I', 'MATH 120', 'Prof. A. Reyes', 2, 50),
  ('Linear Algebra', 'MATH 240', 'Dr. S. Goldberg', 3, 40),
  ('Algorithms & Data Structures', 'CS 301', 'Dr. R. Tanaka', 4, 40),
  ('Database Systems', 'CS 310', 'Prof. L. Ahmed', 4, 45),
  ('Machine Learning', 'CS 420', 'Dr. M. Kowalski', 5, 35),
  ('Genetics', 'BIO 401', 'Prof. D. Okafor', 6, 40)
